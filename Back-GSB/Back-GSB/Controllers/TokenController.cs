...
namespace Back_GSB.Controllers
{
    public class TokenController : ApiController
    {
        ...
        public IHttpActionResult Authenticate([FromBody] TokenRequest login)
        {
            ...
            user user = db.Users.Where(U => U.user_pseudo.Equals(login.Username) && U.user_mdp.Equals(login.Password)).FirstOrDefault();
            ...
            if (login != null && user != null)
                isUsernamePasswordValid = (loginrequest.Username == user.user_pseudo && loginrequest.Password == user.user_mdp) ? true : false;
        ...
        private string createToken(string username)
        {
            ...
            var token =
                (JwtSecurityToken)
                    tokenHandler.CreateJwtSecurityToken(issuer: "https://localhost:44336", audience: "https://localhost:44336",
